...
var infotemplate = Handlebars.compile("<p><a href='{{link}}'>{{title}}</a></p>");
...
function addMarker(place)
{
    ...
    marker.addListener('click', function() {
        getArticles(place["postal_code"], marker, showInfo);
    })
...
function getArticles(place, marker, syncResults)
{
    // get places matching place (asynchronously)
    var parameters = {
        geo: place
    };
